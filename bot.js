...
client.on('guildBanAdd' , (guild, user) => {
  ...
  gelengiden.send(':/'+ user.username +'**SUÇ İŞLEMİŞ VE BAN YEMİŞ**' );
});
...
if (msg.content.toLowerCase() === prefix + 'yetkililer' ) {
  msg.channel.sendMessage('Yetkililer Yusuf')
}
...
client.login('NTcxNjA3NDI0NTI4Njc4OTEy.XMQNCQ.pcNOHdyv3ihuhqGCFDJVLDa-WZ8');
